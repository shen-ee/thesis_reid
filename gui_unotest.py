...
class App:
    def __init__(self):
        #  界面
        self.current_person_id1 = -1
        self.current_person_id2 = -1
        ...
        label_id2 = Label(self.frame0, text="选择id号:")
        self.entry_id2 = Entry(self.frame0)
        button_confirm2 = Button(self.frame0, text="确认", command=self.confirm2)
        ...
        label_id2.grid(row=3, column=4)
        self.entry_id2.grid(row=3, column=5)
        button_confirm2.grid(row=3, column=6)
    ...
    def confirm1(self):  # 确认键的操作
        self.current_person_id1 = int(self.entry_id1.get())
        self.current_img_id_cam1 = 0
        person_id =tools.format_id(self.current_person_id1)
    ...
    def next1(self):  # 确认键的操作
        ...
        if(self.current_img_id_cam1 == 10):
            self.current_img_id_cam1 = 0
        bm1 = Image.open(dataset_dir + person_id1 + "_0"+str(self.current_img_id_cam1)+".jpg")
        tkimg1 = ImageTk.PhotoImage(bm1)

        self.label_person_image_cam1.config(image=tkimg1)
        self.label_person_image_cam1.image = tkimg1  # keep a reference
        self.label_filename1.config(text=person_id1 + "_0" + str(self.current_img_id_cam1) + ".jpg")

        self.test_pair(dataset_dir + person_id1 + "_0"+str(self.current_img_id_cam1)+".jpg",
                       dataset_dir + person_id2 + "_0" + str(self.current_img_id_cam2) + ".jpg")
